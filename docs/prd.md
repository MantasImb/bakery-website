...
- Behavior-focused domain and service tests should live with the module that owns the behavior. Root-level `__tests__` should be reserved for app-level smoke, route, layout, and cross-module integration tests.
